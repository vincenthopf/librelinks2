...
export const EMBED_CONFIGS: EmbedProviderConfig = {
  Instagram: {
    ...
    containerClass:
      'instagram-embed-container w-full max-w-[540px] mx-auto overflow-hidden rounded-lg',
    script: {
  ...
  Twitter: {
    ...
    containerClass:
      'twitter-embed-container w-full max-w-[550px] mx-auto overflow-hidden rounded-lg',
    script: {
