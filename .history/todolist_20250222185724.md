...
- [ ] Fix Pentagon Shape
  - Adjust clipPath coordinates for 2px border
  - Test border completeness
...
- [ ] Create Simple Heart Shape
  - Implement using CSS transforms
  - Use two circles for top lobes
  - Create smooth bottom curve
  - Ensure 2px border visibility
  - Match size with other shapes
  - Test border continuity

## Vertical Oval Fix

- [ ] Update Oval Implementation
  - Set correct aspect ratio (1.5:1)
  - Maintain consistent width
