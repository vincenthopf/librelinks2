      ...
      <div className="relative z-10">
        ...
        <Collapsible open={open} onOpenChange={setOpen}>
          <CollapsibleContent className="animate-accordion-down">
            <div className="mt-3 px-4 py-2 bg-accent/50 rounded-md">
          ...
          <CollapsibleTrigger 
            ...
            className="collapsible-trigger mt-2 w-full text-sm font-medium text-primary-muted hover:text-primary flex items-center gap-2 px-4 py-2 rounded-md hover:bg-accent transition-colors"
          >
            {open ? (
              <>
