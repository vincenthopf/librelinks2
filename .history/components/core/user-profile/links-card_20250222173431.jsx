        ...
        >
          <div className="flex items-center justify-center w-full relative px-4">
            <div className="flex items-center gap-3 max-w-[calc(100%-40px)]">
              <div style={{ width: `${faviconSize}px`, height: `${faviconSize}px` }} className="flex-shrink-0">
                <img
          ...
          {hasPreview && (
            <button
              ...
              className="absolute right-[10px] top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-gray-100 transition-colors z-10"
