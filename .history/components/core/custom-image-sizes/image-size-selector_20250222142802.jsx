      ...
      <div className="mt-4 rounded-2xl border bg-white p-4 w-full h-auto">
        <div className="space-y-6">
          ...
          <div>
            ...
            <select 
              value={imageSizes.profileImage}
              onChange={(e) => handleImageSizeChange('profileImage', parseInt(e.target.value))}
            ...
            <div className="mt-2">
              <div 
                style={{ 
                  width: `${imageSizes.profileImage}px`, 
                  height: `${imageSizes.profileImage}px`,
