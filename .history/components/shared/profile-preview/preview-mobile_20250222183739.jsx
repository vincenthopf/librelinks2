    ...
    <>
      ...
      >
        ...
        >
          <Avatar.Root
            style={{
              width: `${currentUser?.profileImageSize || 70}px`,
              height: `${currentUser?.profileImageSize || 70}px`,
              borderColor: currentUser?.profileFrameColor || DEFAULT_FRAME_COLOR,
              ...getFrameStyles(currentUser?.profileFrameType || DEFAULT_FRAME_TYPE)
            }}
            className={`inline-flex border-2 items-center justify-center overflow-hidden ${getFrameClassName(currentUser?.profileFrameType || DEFAULT_FRAME_TYPE)} align-middle`}
          >
            <Avatar.Image
