...
- [ ] Update User Schema
  ...
  - Add `profileImageSize` field to user model
  - Set default value to 100px
  - Define valid size options (50, 100, 200, 300, 400, 500)

- [ ] Modify API Endpoint
  - Update `/api/edit` to handle `profileImageSize`
...
- [ ] Add Size Selector Component
  ...
  - Create dropdown between "Pick an image" and "Remove"
  - Style to match existing buttons
  - Add size presets with labels
  - Handle onChange events

- [ ] Update UserAvatarSetting Component

  - Modify to accept size prop
  - Update styling for dynamic sizing
  - Maintain aspect ratio
  - Handle image scaling

- [ ] Update Preview Components
  - Modify mobile preview to use dynamic size
  - Modify desktop preview to use dynamic size
  - Ensure real-time updates
  - Test across different size changes

## State Management

- [ ] Add Size State Management
  - Add imageSize state to settings page
  - Update mutation to include size
  - Add size to useUser hook response
