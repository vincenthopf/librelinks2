...
- [ ] Update Layout.jsx container

  - Modify fixed section to use flex layout
  - Update main container overflow handling
  - Adjust preview section container
  - Test scrolling behavior

- [ ] Update Preview Container

  - Modify preview container dimensions
  - Update overflow handling
  - Fix aspect ratio constraints
  - Test responsive behavior

- [ ] Adjust Preview Parent Container
...
- [ ] Update Preview.jsx iframe container

  - Add ResizeObserver for height management
  - Update iframe key prop handling
  - Fix container dimensions
  - Test iframe content display

- [ ] Test Preview Mobile Component
  - Verify mobile preview updates
  - Check padding synchronization
