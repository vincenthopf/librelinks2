...
- [ ] Review existing preview update patterns
  - Study how Themes/Buttons/Font/Image updates work
  - Document the current signalIframe mechanism
  - Review React Query invalidation approach
  - Map out the update flow

## Desktop Preview (preview.jsx)

- [ ] Ensure iframe updates
  - Use existing signalIframe utility
  - Verify React Query cache invalidation
  - Test immediate update reflection
  - Confirm cross-browser compatibility

## Mobile Preview Button (preview-btn.jsx)

- [ ] Verify drawer updates
  - Ensure drawer component receives updates
  - Test immediate preview refresh
  - Verify mobile/iOS compatibility
  - Check update performance

## Mobile Preview Component (preview-mobile.jsx)

- [ ] Implement consistent updates
  - Use same update mechanism as other features
  - Ensure padding changes reflect immediately
...
- [ ] Follow existing patterns
  ...
  - Utilize existing signalIframe mechanism
  - Maintain immediate update behavior
  - Keep consistent with other customization features
...
1. Use existing signalIframe utility for updates
2. Rely on React Query for state management
3. Keep immediate update behavior
4. Maintain consistency with other features
5. Focus on mobile/iOS compatibility

## Implementation Steps:

1. Review how other customization features update previews
2. Use the same signalIframe mechanism
3. Ensure React Query invalidation triggers updates
4. Test across all required browsers and devices
5. Verify immediate update behavior matches other features
