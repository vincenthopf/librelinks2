...
- [ ] Update Preview.jsx iframe key

  - Add profileImageSize to iframe key dependencies
  - Test iframe re-rendering on size changes
  - Verify proper key string formatting
  - Test with different size changes

- [ ] Update Preview Signal Handling
  - Add signalIframe() call to ProfileImageSizeSelector
  - Verify signal is sent on size changes
  - Test signal reception in iframe
  - Add error handling for signal failures

## Size Selector Component

- [ ] Update ProfileImageSizeSelector.jsx
  - Add immediate preview update after size change
  - Add proper error handling
  - Test size change propagation
...
Let's start with updating the Preview.jsx iframe key.
