...
# Profile Picture Customization Implementation Tasks

## Database Changes

- [x] Add profile_frame_type column to users table
  - Default value: 'circle'
  - Allow values: none, circle, rect-h, rect-v, square, oval-v, heart, pentagon, hexagon, heptagon, octagon, nonagon, decagon
- [x] Add profile_frame_color column to users table
  - Default value: '#3B82F6' (blue-300)
  - Store as hex color code

## New Components

- [x] Create ProfileFrameSelector.jsx component
  - Add frame type options constant
  - Create frame type selection UI
  - Add preview for each frame type
  - Handle frame type changes
  - Add frame type validation
- [x] Create ProfileFrameColorPicker.jsx component
  - Add color picker UI
...
- [x] Update /api/customize endpoint
  - Add profileFrameType parameter
  - Add profileFrameColor parameter
...
- [x] Create frame-helpers.ts utility file
  - Add getFrameStyles function
  - Add getFrameClassName function
  - Add frame type validation
  - Add color validation
  - Add shape calculation helpers

## Component Updates

- [x] Update UserAvatar component
  - Add frame type support
  - Add frame color support
  - Update styling
  - Add new props
- [x] Update UserAvatarSetting component
  ...
  - Update styling
  - Add new props
- [x] Update HeaderAvatar component
  - Add frame type support
  - Add frame color support
  - Update styling
  - Add new props
- [x] Update settings/index.jsx
  - Add ProfileFrameSelector
  - Add ProfileFrameColorPicker
  - Add preview section
  - Update layout
...
- [x] Update preview components
  - Add real-time frame type preview
...
# Profile Frame Customization Fixes

## Database Schema & Prisma

- [x] Update Prisma Schema
  - Add profileFrameType field with proper type
  - Add profileFrameColor field with proper type
  - Add default values
  - Add proper field attributes
...
- [x] Apply Database Changes
  - Create migration
  - Apply migration
  - Verify MongoDB collection structure
...
- [x] Update tsconfig.json
  ...
  - Set proper module settings
  - Configure path aliases
  - Add type definitions
- [x] Fix Component Types
  - Update FrameType definitions
...
- [x] Fix ProfileFrameSelector
  - Update mutation error handling
  - Add loading states
  - Improve error feedback
  - Fix type definitions
  - Add proper JSX types
- [x] Fix ProfileFrameColorPicker
  - Update mutation error handling
  - Add loading states
  - Improve error feedback
  - Fix type definitions
...
## Polygon Border Fixes

- [x] Fix Polygon Border Issues
  - [x] Adjusted polygon coordinates to account for 2px border
  - [x] Updated clip-path values for all polygon shapes
  - [x] Added consistent border styling
  - [x] Ensured shapes remain centered

## Heart Shape Implementation

- [x] Implement New Heart Shape
  - [x] Created CSS-based heart shape using pseudo-elements
  - [x] Added proper border handling
  - [x] Maintained consistent size with other shapes
  - [x] Ensured proper color inheritance

## Vertical Oval Fix

- [x] Fix Vertical Oval Shape
  - [x] Updated aspect ratio to 2/3
  - [x] Added explicit border-radius
  - [x] Ensured consistent width with other shapes

## Preview Integration

- [x] Update Preview Component
  - [x] Add profileFrameType to iframe key
  - [x] Add profileFrameColor to iframe key
  - [x] Test frame type changes
  - [x] Test color changes
  - [x] Verify immediate updates
