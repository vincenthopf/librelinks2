...
- [ ] Create Context-Aware Avatar Mode
...
- [ ] Update Settings Avatar Container
...
- [ ] Modify Image Upload Handler
  - Ensure 100px display in settings
  - Maintain aspect ratio handling
  - Test with various image sizes
  - Verify preview sync after upload
...
Let's start with creating the context-aware avatar mode. Would you like me to proceed with that first task?
