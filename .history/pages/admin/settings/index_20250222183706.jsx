    ...
    <>
      ...
      <Layout>
        <div className="w-full lg:basis-3/5 pl-4 pr-4 border-r overflow-scroll">
          ...
          <div className="max-w-[690px] mx-auto my-10">
            <h3 className="text-xl font-semibold">Frame Customization</h3>
              ...
              <div className="flex flex-col gap-4">
                ...
                <AlertDialog.Root>
                  <AlertDialog.Trigger asChild>
                    <button className="w-full lg:w-[200px] h-[45px] border border-red-500 outline-none font-semibold text-red-500 bg-white p-2 rounded-3xl hover:bg-red-50">
                      Delete Account
                    </button>
                  </AlertDialog.Trigger>
