...
/**
 * Get upload parameters for template thumbnails
 * Ensures 9/19 aspect ratio for consistent template display
 */
export const getTemplateUploadParams = templateId => {
  return {
    folder: 'librelinks/template_thumbnails',
    public_id: `template_${templateId}_${Date.now()}`,
    transformation: [
      { width: 360, height: 760, crop: 'fill', quality: 'auto', aspect_ratio: '9:19' },
